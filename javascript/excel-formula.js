   ...
   var fromBase26 = excelFormulaUtilities.fromBase26 = function (number) {
    ...
    function applyTokenTemplate(token, options, indent, lineBreak, override) {
        ...
        case "function":
            ...
            switch (token.value) {
            case "ARRAY":
                tokenString = '**ARRAY-' + tokenString + '-ARRAY**';
                break;
            case "ARRAYROW":
                tokenString = '**ARRAYROW-' + tokenString + '-ARRAYROW**';
                break;
            default:
        ...
        case "operand":
            ...
            case "error":
                tokenString = '**error-' + tokenString + '-error**';
                break;
            case "range":
                tokenString = tokenString;
                break;
            ...
            case "text":
                ...
                break;
            case "argument":
                tokenString = '**argument-' + tokenString + '-argument**';
                break;
            default:
                break;
            }
        ...
        case "operator-infix":
            ...
            break;
        case "logical":
            tokenString = '**logical-' + tokenString + '-logical**';
            break;
        case "argument":
        	if(lastToken.type !== "argument"){
        		tokenString = '"' + tokenString + '"';
            } else  {
            	tokenString = '{ "argument":"' + tokenString + '"}';
            }
            break;
        case "subexpression":
            if (token.subtype.toString() === "start") {
